...
class PostgresTarget(postgreslike.PostgreslikeTarget):
    ...
    def __init__(self, host, database, user, password, table, update_id):
        ...
        """
        postgreslike.PostgreslikeTarget.__init__(self, host, database, user, password, table, update_id)
...
class CopyToTable(postgreslike.CopyToTable):
    ...
    def map_column(self, value):
        ...
        if value in self.null_values:
            ...
            return postgreslike.default_escape(value).encode('utf8')
        else:
            return postgreslike.default_escape(str(value))
